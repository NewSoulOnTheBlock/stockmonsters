...
<!-- GENERATED by tools/compact-atlases.mjs from src/tiled/river.tmx — do not edit.
     Holds only the 889 tiles that map draws, plus every frame of the
     36 animations among them, laid out so each animation is one
     unbroken row-run. Edit the originals in src/tiled/. -->
<tileset version="1.10" tiledversion="1.11.0" name="river-compact" tilewidth="32" tileheight="32" tilecount="889" columns="32">
 <image source="river.png" width="1024" height="896"/>
 <tile id="0">
  <animation>
