...
<!-- GENERATED by tools/compact-atlases.mjs from src/tiled/route.tmx — do not edit.
     Holds only the 371 tiles that map draws, plus every frame of the
     9 animations among them, laid out so each animation is one
     unbroken row-run. Edit the originals in src/tiled/. -->
<tileset version="1.10" tiledversion="1.11.0" name="route-compact" tilewidth="32" tileheight="32" tilecount="371" columns="32">
 <image source="route.png" width="1024" height="384"/>
 <tile id="0">
  <animation>
