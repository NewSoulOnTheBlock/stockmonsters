...
<!-- GENERATED by tools/compact-atlases.mjs from src/tiled/beach.tmx — do not edit.
     Holds only the 1369 tiles that map draws, plus every frame of the
     52 animations among them, laid out so each animation is one
     unbroken row-run. Edit the originals in src/tiled/. -->
<tileset version="1.10" tiledversion="1.11.0" name="beach-compact" tilewidth="32" tileheight="32" tilecount="1369" columns="37">
 <image source="beach.png" width="1184" height="1184"/>
 <tile id="0">
  <animation>
