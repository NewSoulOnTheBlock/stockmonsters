...
<!-- GENERATED by tools/compact-atlases.mjs from src/tiled/marsh.tmx — do not edit.
     Holds only the 603 tiles that map draws, plus every frame of the
     23 animations among them, laid out so each animation is one
     unbroken row-run. Edit the originals in src/tiled/. -->
<tileset version="1.10" tiledversion="1.11.0" name="marsh-compact" tilewidth="32" tileheight="32" tilecount="603" columns="25">
 <image source="marsh.png" width="800" height="800"/>
 <tile id="0">
  <animation>
