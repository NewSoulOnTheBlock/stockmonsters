...
<!-- GENERATED by tools/compact-atlases.mjs from src/tiled/cave.tmx — do not edit.
     Holds only the 580 tiles that map draws, plus every frame of the
     11 animations among them, laid out so each animation is one
     unbroken row-run. Edit the originals in src/tiled/. -->
<tileset version="1.10" tiledversion="1.11.0" name="cave-compact" tilewidth="32" tileheight="32" tilecount="580" columns="32">
 <image source="cave.png" width="1024" height="608"/>
 <tile id="0">
  <animation>
