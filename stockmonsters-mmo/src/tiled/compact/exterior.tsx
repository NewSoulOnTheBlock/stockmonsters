...
<!-- GENERATED by tools/compact-atlases.mjs from src/tiled/exterior.tmx — do not edit.
     Holds only the 1089 tiles that map draws, plus every frame of the
     24 animations among them, laid out so each animation is one
     unbroken row-run. Edit the originals in src/tiled/. -->
<tileset version="1.10" tiledversion="1.11.0" name="exterior-compact" tilewidth="32" tileheight="32" tilecount="1089" columns="33">
 <image source="exterior.png" width="1056" height="1056"/>
 <tile id="0">
  <animation>
